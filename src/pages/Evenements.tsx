        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-500 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 text-center text-white">
            ...
            <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="bg-white text-purple-600 hover:bg-gray-100 px-4 py-2 md:py-3 rounded-full font-medium transition-all text-sm md:text-base whitespace-nowrap">
                S'inscrire
              </button>
            </div>
          </div>
